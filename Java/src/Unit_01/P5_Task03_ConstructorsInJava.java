...
- Every time an object is created using the new() keyword, atleat one constructor is called
...
class ABCD2{
	...
	int display2() {
		System.out.println(a);
		//As b was a local variable so we can't acccess it outside the method 
//		System.out.println(b);
		return a;
	}
}
